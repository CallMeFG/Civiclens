    ...
    <nav className="absolute top-0 left-0 w-full z-50 text-white">
      <div className="max-w-7xl mx-auto px-6 py-6 flex justify-between items-center">
        ...
        <ul className="hidden md:flex gap-8 text-sm font-medium">
          ...
          <li><a href="#fitur" onClick={(e) => scrollToSection(e, 'fitur')} className="hover:text-gray-200 transition">Fitur</a></li>
          <li><a href="#statistik" onClick={(e) => scrollToSection(e, 'statistik')} className="hover:text-gray-200 transition">Statistik</a></li>
        </ul>
          ...
          {isLoggedIn ? (
            <>
              ...
              <button 
                ...
                className="px-5 py-2 border-2 border-white/30 rounded-none hover:bg-red-500 hover:text-white hover:border-red-500 transition-colors cursor-pointer"
              >
                Keluar
              </button>
            </>
            ...
            <>
              <Link to="/login" className="px-5 py-2 border-2 border-white/30 rounded-none hover:bg-white hover:text-primary transition-colors">
                Masuk
              </Link>
              <Link to="/register" className="bg-white text-primary px-5 py-2 rounded-none hover:bg-gray-100 transition-colors">
                Daftar
              </Link>
            </>
          )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-blue-100 text-sm">
              ...
              <li><a href="#statistik" onClick={(e) => scrollToSection(e, 'statistik')} className="hover:text-white transition-colors">Statistik</a></li>
            </ul>
          </div>
          <div>
